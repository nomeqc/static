! function(e, t) {
    ...
    function c(t, r) {
        ...
        var p, m, g, y, b = t.el(),
            ...
            k = 0,
            A = 1,
            I = ["yrirqbirha", "gfbuynpby", "rupnp", "bv.acqp", "zbp.avofw", "gra.yyrufw", "ccn.ofp"];
        s() && (h.zoomMenu = !1);
        t.id();
        var w, T, _, M, L, P, S, H = !1,
            B = t.$(".vjs-tech"),
            z = [],
            N = n(b, ".vjs-big-play-button"),
            q = n(t.el_, ".vjs-loading-spinner");
        if (!0 !== function(e) {
